...
class ExtendedImprovedOnlineGFMM(BaseGFMMClassifier):
    ...
    def _predict(self, Xl, Xu, X_cat, type_boundary_handling=PROBABILITY_MEASURE):
        ...
        features and a bound :math:`Xcat_i` for categorical features, an
        additional criterion based on a probability measure using the number of
        samples included in the hyperbox or the minimum Manhattan distance
